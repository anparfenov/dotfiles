...
vim.cmd 'autocmd BufNewFile,BufFilePre,BufRead *.yml set tabstop=2'
vim.cmd 'autocmd BufNewFile,BufFilePre,BufRead *.yml set softtabstop=2'
vim.cmd 'autocmd BufNewFile,BufFilePre,BufRead *.yml set shiftwidth=2'
